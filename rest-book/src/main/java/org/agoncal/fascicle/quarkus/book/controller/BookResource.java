package org.agoncal.fascicle.quarkus.book.controller;
...
import org.agoncal.fascicle.quarkus.book.service.BookService;
...
public class BookResource {
	...
	@Operation(summary = "Returns a randomm book")
	...
	@Operation(summary = "Returns all the books from database")
	@APIResponse(responseCode = "200", 
			     content = @Content(mediaType = MediaType.APPLICATION_JSON, 
	...
	@Operation(summary = "Returns a book for e given identifier")
	...
	public Response createBook(@RequestBody(required = true, 
											content = @Content(mediaType = MediaType.APPLICATION_JSON,
											schema = @Schema(implementation = Book.class))) @Valid Book book, 
	...
	public Response updateBook(@RequestBody(required = true, 
		...
		LOGGER.debug("Book update with new valued "+book);
		return Response.ok(book).build();		
	}
